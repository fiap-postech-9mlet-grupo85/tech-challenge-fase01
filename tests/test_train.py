...
def test_train_model_pipeline(mock_mlflow, mock_torch_save, mock_joblib_dump, mock_read_csv):
    """
    ...
    mock_df = pd.DataFrame({
        ...
        "TotalCharges": ["29.85", " "] * 5, # Inserindo um 'blank' intencional para testar limpeza
